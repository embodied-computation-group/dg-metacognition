...
if (roundNum == 1)
    ...
    'You can move the cursor around on the scale using the left and right arrow keys and confirm it with the space bar.\n'... 
    ...
    nextpg{i}   = ['__________\n\nNext you will practice making your responses, without a study list. \n\n'...
