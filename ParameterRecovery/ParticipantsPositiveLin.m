...
simTwoGroupsD.params.Ntrials = 500; % Set the number of trials performed
simTwoGroupsD.params.Nratings = 4; % Choose the rating scale to use
simTwoGroupsD.params.Nsims = [50 150 300 600 1000]; % Specify the number of simulations for each session
...
simTwoGroupsD.params.Mratio_rho = [0 0.25 0.50 0.75 1]; % Specify the correlations between the two Mratios
