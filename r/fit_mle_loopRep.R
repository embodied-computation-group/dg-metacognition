...
source(here("r", "parMLEfitrep.R"))

# stop the cluster
stopCluster(cl = my.cluster)

# write out the data file
write.csv(mle_fit_dataRep, file = here("data_summary","mle_mratio_fit_data_repeat.csv"))

save(mle_fit_dataRep,file=here("data_summary", "mle_fitdatarepeat.Rda"))
