...
rownum <- metadata_excMratio %>% group_by (subject) %>% summarise(length(modality))
...
metadata_exc <- subset(metadata_excMratio, !is.element(metadata_excMratio$subject, rowexcID))
...
#Put into APA format: 
ANOTapa<-apa(ANOT, "Table ?: ANOVA of cognitive and metacognitive performances across domains") 
ANOTapa
...
MSapa <-apa(MSTT, "Table 4: Post Hoc: Paired t-tests of Metacognitive Sensitivity (Meta-d')")
MEapa <-apa(METT, "Table 5: Post Hoc: Paired t-tests of Metacognitive Efficiency (Meta-d'/d')")
