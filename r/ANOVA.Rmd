...
ANOT[1,] <- list(paste0("d'"), paste0('F(', dpC_aov1$DFn, ',',dpC_aov1$DFd, ') = ', round(dpC_aov1$F, 3)), paste0('p = ', dpC_aov1$p))
...
MSapa <-apa(MSTT, "Table 3: Post Hoc: Paired t-tests of Metacognitive Sensitivity (Meta-d')")
MEapa <-apa(METT, "Table 3: Post Hoc: Paired t-tests of Metacognitive Efficiency (M-ratio)")
