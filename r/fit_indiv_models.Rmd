...
```
The same but all tasks are combined in one graph: 
```{r}
...
Figure 3: 
```{r}
f1 <- annotate_figure(comPlot2, top = text_grob("Correlation of Metacognitive Efficiency", color = "black", 
                                         face = "bold", size = 14)) 
annotate_figure(f1, top = text_grob("Figure 3", color = "black", 
                                         face = "bold", size = 14)) 
