...
```
Plot the bootstrap samples of correlations: 
```{r}
...
#The plots for the hierarhical model: 
...
Here are some additional plots - you can un-comment these sections to see.
