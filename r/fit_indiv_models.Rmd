...
Confidence <- full_join(AvgConfCorr, AvgConfInCo , by = c("subject" = "subject", "modality"="modality"))



#plot data

pSplit<-ggplot(AvgConfCorr , aes(x = modality, y = avg_conf)) +
  geom_boxjitter() + ggplot(AvgConfInCo , aes(x = modality, y = avg_conf)) +
  geom_boxjitter() +
  ggtitle("Average confidence for Correct and Incorrect Trials")+
  ylab("Average Confidence") + xlab("Modality")

ggplot(AvgConfCorr , aes(x = modality, y = avg_conf)) +
  geom_boxjitter() + ggplot(AvgConfInCo , aes(x = modality, y = avg_conf)) +
  geom_boxjitter() 
