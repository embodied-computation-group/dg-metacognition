...
submetad <- data.frame(
                     mda_memory = na.omit(fit_data_wide$mda_memory),
                     mda_Calories =na.omit(fit_data_wide$mda_Calories),
                     mda_GDP = na.omit(fit_data_wide$mda_GDP),
                     mda_vision =na.omit(fit_data_wide$mda_vision))

#GGCormat - why is correlation between vision and GDP not visualised? Missing data issues. 
#nonparameteric + bootstrapping? just winsorised...? 

ggcorrmat(data = fit_data_wide, cor.vars = c(mda_memory,mda_Calories,mda_GDP,mda_vision),
