...
pacman::p_load(afex, readr, dplyr, tidyr, ggplot2, cowplot, devtools, here, tidyverse, magrittr, reshape2, rjags, coda, lattice, ggmcmc, foreach, doParallel, ggpubr, ggpol, patchwork, ggcorrplot, ggstatsplot, GGally, BayesFactor, gridExtra, viridis, gghalves, gt)
...
```
Table 2: MLE correlatio between domains 
```{r}
...
Table2Hapa<-apa(Table2H, "Table 2.d: Hierarhical Bayesian estimation of correlation of Metacognitive Efficiency")
...
#Put into APA format.                                     
table3apa<-apa(table3, "Table 3: Cognitive and Metacognitive performance")
