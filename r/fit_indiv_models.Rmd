...
#Change labels
BayesSen <- BayesSenE %>% mutate(`meta-d'` = `Bayes Factor`) %>% select(-`Bayes Factor`)
BayesEff <- BayesEffE %>% mutate(`meta-d/d''` = `Bayes Factor`) %>% select(-`Bayes Factor`)
BayesBia <- BayesBiaE %>% mutate(`Avg. Conf` = `Bayes Factor`) %>% select(-`Bayes Factor`)
