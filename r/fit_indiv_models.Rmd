...
RhoPlot <- ggarrange(Rho1, Rho2, Rho3, Rho4, Rho5, Rho6)
CorHi <- annotate_figure(RhoPlot, top = text_grob("Hierarhical Bayesian estimation", color = "black", face = "bold", size = 14)) 

#MLE fit
CorMLE <- annotate_figure(comPlot3, top = text_grob("Maximum likelihood estimation  ", color = "black", face = "bold", size = 14)) 
