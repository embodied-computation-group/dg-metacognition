...
BayesSen[4,] <-list(paste0('GDP & Vision'), paste0(round(bf4@bayesFactor$bf,3))) 
BayesSen[5,] <-list(paste0('GDP & Calories'), paste0(round(bf5@bayesFactor$bf,3))) 
BayesSen[6,] <-list(paste0('Vision & Calories'), paste0(round(bf6@bayesFactor$bf,3)))
...
BayesEff[4,] <-list(paste0('GDP & Vision'), paste0(round(bf14@bayesFactor$bf,3))) 
BayesEff[5,] <-list(paste0('GDP & Calories'), paste0(round(bf15@bayesFactor$bf,3))) 
BayesEff[6,] <-list(paste0('Vision & Calories'), paste0(round(bf16@bayesFactor$bf,3)))
...
BayesBia[4,] <-list(paste0('GDP & Vision'), paste0(round(bf24@bayesFactor$bf,3))) 
BayesBia[5,] <-list(paste0('GDP & Calories'), paste0(round(bf25@bayesFactor$bf,3))) 
BayesBia[6,] <-list(paste0('Vision & Calories'), paste0(round(bf26@bayesFactor$bf,3)))
...
BayesCog[4,] <-list(paste0('GDP & Vision'), paste0(round(bf34@bayesFactor$bf,3))) 
BayesCog[5,] <-list(paste0('GDP & Calories'), paste0(round(bf35@bayesFactor$bf,3))) 
BayesCog[6,] <-list(paste0('Vision & Calories'), paste0(round(bf36@bayesFactor$bf,3)))

#Create the Excel tables: 
write.csv(BayesCog ,file= here("tables", 'bayes_dprime.csv'))
write.csv(BayesEff ,file= here("tables", 'bayes_efficiency.csv'))
write.csv(BayesBia ,file= here("tables", 'bayes_metabias.csv'))
write.csv(BayesSen ,file= here("tables", 'bayes_metasens.csv'))
