...
write.csv(fit_dataEven, file = here("data_summary","mle_mratio_fit_data.csv"))
...
write.csv(fit_data_wideEven, file = here("data_summary","mle_mratio_fit_data_wideEven.csv"))
head(fit_data_wideEven)
...
write.csv(fit_data_wideEvenF, file = here("data_summary","mle_mratio_fit_data_wideEvenF.csv"))
head(fit_data_wideEvenF)
...
write.csv(fit_data_wideOdd, file = here("data_summary","mle_mratio_fit_data_wide.csv"))
head(fit_data_wideOdd)
#filtered: 
fit_data_wideOddF <- fit_dataOdd %>% pivot_wider(
  names_from = modality,
  values_from = c(da, mda, mratio, c)
)
write.csv(fit_data_wideOddF, file = here("data_summary","mle_mratio_fit_data_wideF.csv"))
head(fit_data_wideOddF)
...
corrtable[1,] <- list("Mratio",res1$estimate,res1$conf.int[1], res1$conf.int[2], res1$p.value,
...
corrtableF[1,] <- list("Mratio",res1$estimate,res1$conf.int[1], res1$conf.int[2], res1$p.value,
                       res2$estimate,res2$conf.int[1], res2$conf.int[2], res2$p.value,
                       res3$estimate,res3$conf.int[1], res3$conf.int[2],  res3$p.value,
                       res4$estimate,res4$conf.int[1], res4$conf.int[2],  res4$p.value)
