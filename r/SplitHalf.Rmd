...
write.csv(fit_data_wideOdd, file = here("data_summary","mle_mratio_fit_data_wideOdd.csv"))
...
write.csv(fit_data_wideOddF, file = here("data_summary","mle_mratio_fit_data_wideOddF.csv"))
