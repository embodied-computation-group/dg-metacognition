...
ggsave(here("figs", "Hier_Rho_scatter.png"), width = max_width_cm, height = height_cm, units = "cm", dpi = 300)

ggsave(here("figs", "Hier_Rho_scatter.jpeg"), width = max_width_cm, height = height_cm, units = "cm", dpi = 300)
